 ...
 * si se ingresa cada uno de los siguientes números, qué opción (1 o 2) elegirías en cada caso?
 ...
 * Luego, descomentá las ultimas 2 lineas del script, así ya podés ir ejecutando el código para verificar...
 */
...
function mostrarResultado(resultado, opcion, numero, nombreFuncion) {
    let datosFuncion =
    ...
    if (resultado === opcion) {
        ...
        alert(
            "Cuidado! la opción correcta " + datosFuncion + " es: " + resultado
        );
    }
}
...
mostrarResultado(resultado, opcion, numUsuario, "comparacion");
